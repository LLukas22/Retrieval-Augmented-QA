"""
  This was extracted from https://github.com/deepset-ai/haystack/blob/main/haystack/schema.py
  to use the schemas in a consuming application without depending on the haystack package
"""
